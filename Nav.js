...
export default class Nav extends Component {
  render(){
    ...
    return (
      <div>
        <nav className="navbar navbar-inverse" style={{fontWeight: 'bold', fontSize: '28px'}}>
          <div className="container-fluid">
            <div className="navbar-header">
              ...
              <a className="navbar-brand" href={brandLink} target="_blank"> Assignment for Terribly Tiny Tales </a>
            </div>
          </div>
        </nav>
        {this.props.children}
